...
- NFC_WAIT: ожидание NFC-сканирования после успешного ответа 200 от распознавания **или после ручного ввода MRZ-полей и нажатия “Проверка через чип”**; включается NFC-dispatch.
